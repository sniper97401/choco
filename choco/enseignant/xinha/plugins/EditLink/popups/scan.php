<?php
     ...
     //  lien relatif vers le répertoire à scanner
     // ici on remonte jusqu'au dossier cahier_de_textes à partir de ce fichier
     // edit_link.php ecrit ces variables à partir des variables de session
     // $dir = "../../../../../";
     // $url_abs = "http://127.0.0.1/touchard_local/cahier_de_textes";

    $include      = '/\.(shtml|html|htm|jpeg|gif|txt|doc|pdf|rtf|xml|csv)$/';    //les extensions à prendre en compte
    $exclude      = '';
    $dirinclude   = '';
